...
export sysconfdir=/etc
 VER_COMMON="-D UNIX_LUX -D HAVE_CONFIG_H -D MODULE_IAS -D ENABLE_OPENSSL -D ENABLE_GALSS -D OPENSCPKCS11_EXPORTS -D PKCS11_THREAD_LOCKING -D ENABLE_PCSC -D _MULTI_THREADED -D HAVE_WINSCARD_H -DUNIX_X64"
#VER_COMMON="-D UNIX_LUX -D HAVE_CONFIG_H -D MODULE_IAS -D ENABLE_OPENSSL -D ENABLE_GALSS -D OPENSCPKCS11_EXPORTS -D PKCS11_THREAD_LOCKING -D ENABLE_PCSC -D _MULTI_THREADED -DUNIX_X64"
...
export CFLAGS="-fPIC ${VER} -m64 -c -Wall"
export CFLAGS_TST="-m64 -c -Wall ${VER} -D WITH_OPENSSL -D NEW_VERSION_PROD"
export LDFLAGS="-shared -fPIC -Wl"
export LDFLAGS_TST=
